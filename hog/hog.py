...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (score0 < goal) and (score1 < goal):
        ...
        if (who == 0):
            ...
            tmp_score = 0
            tmp_score = take_turn(num_dice, score1, dice)
            score0 += tmp_score
            ...
            tmp_score = 0
            tmp_score = take_turn(num_dice, score0, dice)
            score1 += tmp_score
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def out(s1, s2):
        if (who == 1):
            ...
            sub = s2 - tmp
            if (sub > running_high):
                print(sub, 'point(s)! The most yet for Player 1')
                return announce_highest(who, s2, sub)
            else:
                return announce_highest(who, s2, running_high)
        else:
            tmp = last_score
            sub = s1 - tmp
            if (sub > running_high):
                print(sub, 'point(s)! The most yet for Player 0')
                return announce_highest(who, s1, sub)
            else:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    flg = 0
    while num <= 10:
        tmp1 = make_averaged(roll_dice, trials_count)
        tmp = tmp1(num, dice)
        if (tmp > maxn):
            maxn = tmp
            flg = num
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    get_back = free_bacon(opponent_score)
    if (get_back >= cutoff):
        return 0
    else:
        return num_rolls
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    get_back0 = free_bacon(opponent_score)
    if (extra_turn(score + get_back0, opponent_score)):
        return 0
    else:
        if (get_back0 >= cutoff):
            return 0
